...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if ($res) {
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            ...
            echo json_encode(array("led1" => $row["led1"], "led2" => $row["led2"], "method" => "get"));
        }
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo json_encode(array("led1" => $led1, "led2" => $led2, "method" => "post"));
    ...
    // if (!$con->query($sql)) echo "faild to update";
